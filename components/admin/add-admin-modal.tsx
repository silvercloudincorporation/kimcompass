...
export function AddAdminModal({ open, onClose, onAdd, roles, permissionGroups, isLoading }: AddAdminModalProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>The role determines the default set of permissions.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
