...
export default function CreateFamilyHistoryModal({ open, onClose }: CreateFamilyHistoryModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Create Family History</DialogTitle>
          <DialogDescription>Add a new family history to the platform.</DialogDescription>
        </DialogHeader>
        <Form {...form}>
